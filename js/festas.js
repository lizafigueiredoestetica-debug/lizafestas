/* =====================================================
   ...
   Catálogo de festas (antigo "Serviços")
   Nota: dados internos continuam em db.servicos —
   só a UI/label mudou para "Festas"
   ===================================================== */
...
function salvarEditFesta(id) {
  ...
  saveData(); renderAll(); showToast('Festa atualizada!');
}
